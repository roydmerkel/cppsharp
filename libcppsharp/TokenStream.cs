    ...
    public class TokenStream
    {
        ...
        public TokenStream(bool handleTrigraphs = false, bool handleDigraphs = false, bool allowSlashNInString = true, bool treatStringSlashNAsNothing = true)
        {
            ...
            List<TokenMatch> defaultStateMatches = new List<TokenMatch>()
            {
                ...
                new TokenMatch(new Regex(@"\.(?:\\\n)*\.(?:\\\n)*\.", RegexOptions.Compiled), delegate(out Token[] tokOut, ref State state, string matchString, Match match, ref int curColumn, ref int curLine) { tokOut = new Token[] { new Token(TokenType.ELLIPSE, "...", null) }; curColumn += matchString.Length; }),
                ...
                new TokenMatch(new Regex(@"(?:\\\n)*s(?:\\\n)*i(?:\\\n)*z(?:\\\n)*e(?:\\\n)*o(?:\\\n)*f(?:\\\n)*", RegexOptions.Compiled), delegate(out Token[] tokOut, ref State state, string matchString, Match match, ref int curColumn, ref int curLine) { tokOut = new Token[] { new Token(TokenType.SIZEOF, "sizeof", null) }; curColumn += matchString.Length; }),
                new TokenMatch(new Regex(@"(?:\\\n)*d(?:\\\n)*e(?:\\\n)*f(?:\\\n)*i(?:\\\n)*n(?:\\\n)*e(?:\\\n)*d(?:\\\n)*", RegexOptions.Compiled), delegate(out Token[] tokOut, ref State state, string matchString, Match match, ref int curColumn, ref int curLine) { tokOut = new Token[] { new Token(TokenType.SIZEOF, "defined", null) }; curColumn += matchString.Length; }),

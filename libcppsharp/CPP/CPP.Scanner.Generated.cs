...
//  UserName: rmerkel
//  GPLEX input file <CPP/CPP.Language.analyzer.lex - 3/12/2018 2:13:25 PM>
...
#if BABEL
     internal sealed partial class CPPScanner : ScanBase, IColorScan
    {
...
#else  // BABEL
     internal sealed partial class CPPScanner : ScanBase
    {
        private ScanBuff buffer;
        int currentScOrd;  // start condition ordinal
#endif // BABEL
...
#if !NOFILES
     internal CPPScanner(Stream file) {
